...
//        List<WorkflowRole> ticketCreationRole = new WorkflowRole("CSR");
...
//        List<WorkflowRole> fierghtFormReleaseRole = new WorkflowRole("CSR");
...
//        List<WorkflowRole> fierghtFormInProcessRole = new WorkflowRole("FP");
...
////        WorkflowStatus fierghtFormReleaseStatus = new WorkflowStatus(1000, "FREIGHT_RELEASED", "Freight form relased to FP");
//        List<WorkflowRole> changesFromCustomerDivergeGatewayComponentRole = new WorkflowRole("CSR");
...
////        WorkflowStatus fierghtFormReleaseStatus = new WorkflowStatus(1000, "FREIGHT_RELEASED", "Freight form relased to FP");
//        List<WorkflowRole> cancelOrRerouteDivergeGatewayComponentRole = new WorkflowRole("CSR");
...
//        List<WorkflowRole> reRouteRuleTaskComponentRole = new WorkflowRole("CSR");
...
//        List<WorkflowRole> bookingDoneComponentRole = new WorkflowRole("FP");
...
//        List<WorkflowRole> destinationCountryReachedComponentRole = new WorkflowRole("FP");
...
//        List<WorkflowRole> approvedComponentRole = new WorkflowRole("FP");
...
//        List<WorkflowRole> waitingForClearanceComponentRole = new WorkflowRole("FP");
...
//        List<WorkflowRole> reachedDestinationComponentRole = new WorkflowRole("FP");
...
//        List<WorkflowRole> podUploadComponentRole = new WorkflowRole("FP");
